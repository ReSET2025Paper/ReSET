...
#     @torch.no_grad()
#     def get_action(self, obs_dict: dict[str, np.ndarray]) -> tuple[np.ndarray | None, bool]:
...
#     def get_loss(self, batch: dict[str, torch.Tensor]) -> tuple[torch.Tensor, dict[str, float]]:
